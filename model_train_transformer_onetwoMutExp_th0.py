# 独立测试集还有0.8774，两点200有0.7063(单点只有0.65左右)
import numpy as np
import pandas as pd
import torch
import os
...
class CustomData(Dataset):
    ...
    def __init__(self, 
        ...
        expdata_2mut_pos = expdata_2mut[expdata_2mut['label']==1]
        expdata_2mut_neg = expdata_2mut[expdata_2mut['label']==0]

        selected_data = pd.concat([expdata_1mut, expdata_2mut])
    ...
    for fold in range(5):
        ...
        # for epoch in (range(NUM_EPOCHS)):
            ...
            # if val_prauc > best_PRAUC:
                ...
                save_path = './output/models/Transformer_atten_onetwomut_th0/'
